set moduleName ipv4_drop_optional_ip_header_64_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ipv4_drop_optional_ip_header<64>}
set C_modelType { void 0 }
set C_modelArgList {
	{ rx_process2dropLengthFifo int 4 regular {fifo 0 volatile } {global 0}  }
	{ rx_process2dropFifo int 128 regular {fifo 0 volatile } {global 0}  }
	{ rx_ip2udpFifo int 128 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rx_process2dropLengthFifo", "interface" : "fifo", "bitwidth" : 4, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rx_process2dropFifo", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "rx_ip2udpFifo", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ rx_process2dropFifo_dout sc_in sc_lv 128 signal 1 } 
	...
	{ rx_ip2udpFifo_din sc_out sc_lv 128 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rx_process2dropFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "rx_process2dropFifo", "role": "dout" }} , 
 	...
 	{ "name": "rx_ip2udpFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "rx_ip2udpFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	rx_process2dropFifo { ap_fifo {  { rx_process2dropFifo_dout fifo_port_we 0 128 }  { rx_process2dropFifo_num_data_valid fifo_status_num_data_valid 0 4 }  { rx_process2dropFifo_fifo_cap fifo_update 0 4 }  { rx_process2dropFifo_empty_n fifo_status 0 1 }  { rx_process2dropFifo_read fifo_data 1 1 } } }
	rx_ip2udpFifo { ap_fifo {  { rx_ip2udpFifo_din fifo_port_we 1 128 }  { rx_ip2udpFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rx_ip2udpFifo_fifo_cap fifo_update 0 2 }  { rx_ip2udpFifo_full_n fifo_status 0 1 }  { rx_ip2udpFifo_write fifo_data 1 1 } } }
}
